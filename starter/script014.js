...
//const message = prompt("Bonjour")
    ...
    if (message === "Bonjour"){
        console.log("Toi, tu es poli, tu me dis bonjour, je veux bien te parler…")
    }
...
const poidsJohn = 78;
const tailleMark = 92;
const poidsMark = 1.95;
const bmiJohn = poidsMark/tailleMark*tailleMark;
const bmiMark = tailleMark/poidsMark*poidsMark;
console.log(bmiMark)
...
const nombre = Number(prompt("Entrez un nombre"))
if (nombre %2 === 0){
console.log("Lr nombre est pair")
}else {
